...
namespace ATM_Final
{
    public partial class BalanceRPT : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                timer1.Start();
                DGV1.DataSource = xDB.Selectcmd("Select * from tblTransactions where AccountNo = '" + txtSearch.Text + "'");
        ...
        private void BalanceRPT_Load(object sender, EventArgs e)
        {
            xDB = new ConnectDB();
        ...
        {
            DGV1.DataSource = xDB.Selectcmd("Select * from tblTransactions");
            DGV1.Columns[0].Width = 50;
            DGV1.Columns[1].Width = 50;
