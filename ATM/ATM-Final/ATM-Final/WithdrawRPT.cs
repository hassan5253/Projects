...
namespace ATM_Final
{
    public partial class WithdrawRPT : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                timer1.Start();
                DGV1.DataSource = xDB.Selectcmd("Select * from tblTransactions where AccountNo = '" + txtSearch.Text + "' and Remarks='WithDraw Amount'");
        ...
        private void WithdrawRPT_Load(object sender, EventArgs e)
        {
            xDB = new ConnectDB();
        ...
        {
            DGV1.DataSource = xDB.Selectcmd("Select * from tblTransactions Where Remarks='WithDraw Amount'");
            DGV1.Columns[0].Width = 50;
            DGV1.Columns[1].Width = 50;
